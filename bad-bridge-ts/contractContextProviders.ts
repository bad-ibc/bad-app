...
import { BadBridgeClient } from "./BadBridge.client";
import { BadBridge } from "./BadBridge.provider";
export interface IContractsContext {
  hackCw20: IQueryClientProvider<HackCw20QueryClient> & ISigningClientProvider<HackCw20Client>;
  badBridge: IQueryClientProvider<BadBridgeQueryClient> & ISigningClientProvider<BadBridgeClient>;
}
