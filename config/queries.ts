...
export const TOKENS = gql`
  query Tokens($collectionAddr: String, $limit: Int) {
...
export const COLLECTIONS_MINT = gql`
...
export const OWNED_TOKENS = gql`
  query Tokens($ownerAddr: String, $badkidsAddress: String, $sortBy: TokenSortBy, $limit: Int) {
    tokens(ownerAddr: $ownerAddr, collectionAddr: $badkidsAddress, sortBy: $sortBy, limit: $limit) {
      total
      tokens {
        collectionAddr
        name
